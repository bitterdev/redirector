...
use Concrete\Package\Redirector\Controller\Dialog\Support\CreateTicket;
...
<form action="<?php echo (string)Url::to("/ccm/system/dialogs/redirector/create_ticket/submit"); ?>"
      data-dialog-form="create-ticket"
      method="post"
      enctype="multipart/form-data">

    <?php echo $form->hidden('projectHandle', "redirector"); ?>
